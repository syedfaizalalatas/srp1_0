...
<?php  
$_SESSION['page_title'] = "Pengurusan Rekod Kategori";
$_SESSION['addnew_form_title'] = "Borang Tambah Rekod Kategori";
$_SESSION['addnew_form_action'] = "Simpan Kategori Baharu";
$_SESSION['update_form_title'] = "Borang Kemaskini Rekod Kategori";
$_SESSION['update_form_action'] = "Kemaskini Kategori Sedia Ada";
$_SESSION['table_title'] = "Jadual Rekod Kategori";
$_SESSION['table_action'] = "Senaraikan Kategori";
$actionfilename = "categorymgmt.php";
$table01name = "kategori";
$field01name = "kod_kat";
$field02name = "nama_kat";
						...
						<div class="x_content">
							...
							<form id="form-data-baharu" action="<?php echo $actionfilename; ?>" method="POST" data-parsley-validate class="form-horizontal form-label-left">
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="kod_data" hidden="hidden">Kod Kategori 
									</label>
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_data">Nama Kategori <span class="required">*</span>
									</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="papar_data">Papar Kategori? 
									</label>
					    			<div class="checkbox">
					    				<label>
