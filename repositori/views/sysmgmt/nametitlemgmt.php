...
<?php  
$_SESSION['page_title'] = "Pengurusan Rekod Gelaran Nama";
$_SESSION['addnew_form_title'] = "Borang Tambah Rekod Gelaran Nama";
$_SESSION['addnew_form_action'] = "Simpan Gelaran Nama Baharu";
$_SESSION['update_form_title'] = "Borang Kemaskini Rekod Gelaran Nama";
$_SESSION['update_form_action'] = "Kemaskini Gelaran Nama Sedia Ada";
$_SESSION['table_title'] = "Jadual Rekod Gelaran Nama";
$_SESSION['table_action'] = "Senaraikan Gelaran Nama";
$actionfilename = "nametitlemgmt.php";
$table01name = "gelaran_nama";
$field01name = "kod_gelaran_nama";
$field02name = "gelaran_nama";
...
if (isset($_POST['btn_kemaskini_data'])) {
	...
	$temp_nama_data = addslashes($_POST['nama_data']);
	$_SESSION['nama_data'] = $temp_nama_data;
	...
	<div class="">
						...
						<div class="x_content">
							...
							<form id="form-data-baharu" action="<?php echo $actionfilename; ?>" method="POST" data-parsley-validate class="form-horizontal form-label-left">
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="kod_data" hidden="hidden">Kod Gelaran Nama 
									</label>
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_data">Nama Gelaran Nama <span class="required">*</span>
									</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="papar_data">Papar Gelaran Nama? 
									</label>
					    			<div class="checkbox">
					    				<label>
		...
		<!-- <div class="row"> -->
			<!-- <div class="col-md-12 col-sm-12 col-xs-12"> -->
				<!-- <div class="x_panel"> -->
					<!-- <div class="x_title"> -->
						<!-- <h2><?php echo "Ruang Ujian"; ?> <small><?php echo "Ruang Ujian"; ?></small></h2> -->
						<!-- <div class="clearfix"></div> -->
					<!-- </div> -->
					<!-- <div class="x_content"> -->
						<!-- <p> -->
							<?php  
								// $text="Dato' Kucing";
								// echo $text."<br/>";
								// $cleanedText=addslashes($text);
								// echo $cleanedText."<br/>";
								// $retrievedText=stripslashes($cleanedText);
								// echo $retrievedText."<br/>";
							?>
						<!-- </p> -->
					<!-- </div> -->
				<!-- </div> -->
					...
					<div class="x_content">
						...
						<table id="datatable-buttons" class="table table-striped table-bordered">
							<thead>
								<tr>
									<th width="40">Bil</th>
									<th width="100" <?php echo $_SESSION['code_display_status']; ?>>Kod</th>
									<th>Nama</th>
									<th>Status</th>
									<th>Tindakan</th>
								</tr>
							...
							<tbody>
								<?php 
								fnShowNameTitleTableContent($DBServer,$DBUser,$DBPass,$DBName,$table01name,$field01name,$field02name); 
								?>
							</tbody>
						</table>
						</form>
