...
<?php  
$_SESSION['page_title'] = "Pengurusan Rekod Kementerian";
$_SESSION['addnew_form_title'] = "Borang Tambah Rekod Kementerian";
$_SESSION['addnew_form_action'] = "Tambah Rekod Kementerian";
$_SESSION['update_form_title'] = "Borang Kemaskini Rekod Kementerian";
$_SESSION['update_form_action'] = "Kemaskini Kementerian Sedia Ada";
$_SESSION['table_title'] = "Jadual Rekod Kementerian";
$_SESSION['table_action'] = "Senaraikan Kementerian";
$actionfilename = "ministrymgmt.php";
$table01name = "kementerian";
$field01name = "kod_kem";
$field02name = "nama_kem";
...
if (isset($_POST['btn_kemaskini_data'])) {
	...
	<?php
	fnUpdateMinistry($DBServer,$DBUser,$DBPass,$DBName,$table01name,$field01name,$field02name,$_POST['kod_data']);
}
...
if (isset($_POST['btn_simpan_data_contoh'])) {
	...
	$_SESSION['id_pengemaskini'] = $_SESSION['loggedinid'];
	$_SESSION['tkh_kemaskini'] = date("Y-m-d H:i:s");
	fnInsertNewMinistry($DBServer,$DBUser,$DBPass,$DBName,$table01name,$field01name,$field02name);
}
?>
<!-- page content -->
						...
						<div class="x_content">
							...
							<form id="form-data-baharu" action="<?php echo $actionfilename; ?>" method="POST" data-parsley-validate class="form-horizontal form-label-left">
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="kod_data">Kod Kementerian 
									</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" id="kod_data" name="kod_data" maxlength="11" autofocus class="form-control col-md-7 col-xs-12">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_data">Nama Kementerian <span class="required">*</span>
									</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
