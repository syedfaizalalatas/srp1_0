...
<?php  
$_SESSION['page_title'] = "Pengurusan Rekod Status Dokumen";
$_SESSION['addnew_form_title'] = "Borang Tambah Rekod Status Dokumen";
$_SESSION['addnew_form_action'] = "Simpan Status Dokumen Baharu";
$_SESSION['update_form_title'] = "Borang Kemaskini Rekod Status Dokumen";
$_SESSION['update_form_action'] = "Kemaskini Status Dokumen Sedia Ada";
$_SESSION['table_title'] = "Jadual Rekod Status Dokumen";
$_SESSION['table_action'] = "Senaraikan Status Dokumen";
$actionfilename = "docstatusmgmt.php";
$table01name = "status";
$field01name = "kod_status";
$field02name = "nama_status";
						...
						<div class="x_content">
							...
							<form id="form-data-baharu" action="<?php echo $actionfilename; ?>" method="POST" data-parsley-validate class="form-horizontal form-label-left">
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="kod_data" hidden="hidden">Kod Status Dokumen 
									</label>
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_data">Nama Status Dokumen <span class="required">*</span>
									</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="papar_data">Papar Status Dokumen? 
									</label>
					    			<div class="checkbox">
					    				<label>
