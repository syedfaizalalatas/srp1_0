...
<?php  
$_SESSION['page_title'] = "Pengurusan Rekod Sektor";
$_SESSION['addnew_form_title'] = "Borang Tambah Rekod Sektor";
$_SESSION['addnew_form_action'] = "Simpan Sektor Baharu";
$_SESSION['update_form_title'] = "Borang Kemaskini Rekod Sektor";
$_SESSION['update_form_action'] = "Kemaskini Sektor Sedia Ada";
$_SESSION['table_title'] = "Jadual Rekod Sektor";
$_SESSION['table_action'] = "Senaraikan Sektor";
$actionfilename = "sectormgmt.php";
$table01name = "sektor";
						...
						<div class="x_content">
							...
							<form id="form-data-baharu" action="<?php echo $actionfilename; ?>" method="POST" data-parsley-validate class="form-horizontal form-label-left">
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="kod_data" hidden="hidden">Kod Sektor 
									</label>
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_data">Nama Sektor <span class="required">*</span>
									</label>
									<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<div class="form-group">
									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="papar_data">Papar Sektor? 
									</label>
					    			<div class="checkbox">
					    				<label>
