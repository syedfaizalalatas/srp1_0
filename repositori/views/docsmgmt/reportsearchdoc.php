...
<?php  
$_SESSION['page_title'] = "Laporan Rekod Dokumen";
...
$_SESSION['update_form_title'] = "Borang Pilihan Rekod";
...
$actionfilename = "reportsearchdoc.php";
$table01name = "dokumen";
...
# bila pengguna ketik 'Pilih' dalam borang pilihan rekod
if (isset($_POST['sbmt_cari_lengkap'])) {
	...
	if ($_SESSION['verifiedOK'] == 3) {
		...
		if ($_SESSION['field_filled_counter'] > 0) {
			...
			// fnClearAdvancedDocSearchSessions(); // komenkan sementara 20180808 1710 // mmg perlu komenkan sebab akan buat hasil =0
				...
				<div class="x_panel">
					...
					<div class="x_content">
						<form id="form-data-baharu" action="<?php echo $actionfilename; ?>" method="POST" data-parsley-validate class="form-horizontal form-label-left">
							...
							<div class="form-group">
								<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
									<input type="submit" id="sbmt_cari_lengkap" name="sbmt_cari_lengkap" class="btn btn-success" value="Pilih">
									<button type="reset" class="btn btn-danger">Kosongkan</button>
								</div>
							</div>
						</form>
								...
								<table id="myTable" class="table table-striped table-bordered">
									<thead>
										<tr>
											...
											<th width="100" hidden>Kod</th>
											<th>Tajuk</th>
											<th width="160" hidden>Tindakan</th>
										</tr>
									</thead>
