...
$_SESSION['table_title'] = "Statistik mengikut Status Dokumen";
$_SESSION['table_action'] = "Senaraikan Dokumen";
$actionfilename = "docreport_stat.php";
$table01name = "status";
          ...
          <div class="x_content">
            ...
            <table id="myTable" class="table table-striped table-bordered">
              ...
              <tbody id="myTableBody">
                <?php 
                fnShowDocReportByStat($DBServer,$DBUser,$DBPass,$DBName,$table01name,$field01name,$field02name); 
                ?>
                <tr>
                  <td colspan="2" align="right"><strong>JUMLAH</strong></td>
                  <td align="center"><strong><?php echo $_SESSION['jum_semua_stat']; ?></strong></td>
                </tr>
              </tbody>
            </table>
            </form>
