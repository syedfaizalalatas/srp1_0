...
$_SESSION['table_title'] = "Statistik mengikut Kategori";
$_SESSION['table_action'] = "Senaraikan Dokumen";
$actionfilename = "docreport_cat.php";
          ...
          <div class="x_content">
            ...
            <table id="myTable" class="table table-striped table-bordered">
              ...
              <tbody id="myTableBody">
                <?php 
                fnShowDocReportByCat($DBServer,$DBUser,$DBPass,$DBName,$table01name,$field01name,$field02name); 
                ?>
                <tr>
