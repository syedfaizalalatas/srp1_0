...
$_SESSION['table_title'] = "Statistik mengikut Bahagian";
$_SESSION['table_action'] = "Senaraikan Dokumen";
$actionfilename = "docreport_div.php";
          ...
          <div class="x_content">
            ...
            <table id="myTable" class="table table-striped table-bordered">
              ...
              <tbody id="myTableBody">
                <?php 
                fnShowDocReportByDiv($DBServer,$DBUser,$DBPass,$DBName,$table01name,$field01name,$field02name); 
                ?>
                <tr>
                  <td colspan="2" align="right"><strong>JUMLAH</strong></td>
                  <td align="center"><strong><?php echo $_SESSION['jum_semua_bah']; ?></strong></td>
                </tr>
              </tbody>
            </table>
            </form>
