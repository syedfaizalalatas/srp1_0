...
$_SESSION['table_title'] = "Statistik Mengikut Tahun";
$_SESSION['table_action'] = "Senarai Rekod";
$actionfilename = "docreport_year.php";
$table01name = "dokumen";
$field01name = "kod_dok";
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <div class="title_right">
              <div hidden class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
            ...
            <!-- <table id="datatable-buttons" class="table table-striped table-bordered tablesorter"> -->
                <?php 
                // fnShowDocReportSelectYear($DBServer,$DBUser,$DBPass,$DBName,$table01name,$field01name,$field02name); 
                ?>
            <?php
            ...
            <!-- <div class="col-md-12 col-sm-12 col-xs-12 form-group text-center"> -->
                <!-- <form action="listdocfromreport.php" method="GET"> -->
                    <!-- <input type="text" value="l" name="s" id="s" hidden><br/> -->
                    <!-- <input type="text" value="t" name="j" id="j" hidden><br/> -->
                    <!-- <select name="tahun_dok" id="tahun_dok"> -->
                        ...
                        $counter = 1;
                        foreach($arr as $row) {
                            $tahun_rekod = stripslashes(strtoupper($row['tahun_dok']));
                            ?>
            ...
            <table id="myTable" class="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th>Tahun Rekod</th>
                  <th width="115" hidden>Kategori</th>
                  <th width="115">Bilangan</th>
                </tr>
              </thead>
              ...
              <tbody id="myTableBody">
                ...
                fnShowDocReportSelectYear(); 
                // fnRunAlert($_SESSION['jum_semua_kat']);
                ?>
                <tr>
                  <td colspan="2" align="right"><strong>JUMLAH</strong></td>
                  <td align="center"><strong><?php echo $_SESSION['jum_semua_kat']; ?></strong></td>
                </tr>
              </tbody>
            </table>
            <div class="col-md-12 text-center">
              <ul hidden class="pagination pagination-lg pager" id="myPager"></ul>
            </div>
          </div>
        </div>
      </div>
