        ...
        <div class="container">
            ...
            <div class="col-sm-6 col-md-5">
                <div class="infoBox">
                    ...
                    <p class="infoText">
                         Sistem Repositori Pekeliling (SRP) dibangunkan selaras dengan keputusan Mesyuarat Panel Merakyatkan Perkhidmatan Awam (MPA) bil. 1 tahun 2016 yang dipengerusikan oleh Ketua Setiausaha Negara (KSN) pada 30 Mac 2016 untuk menyediakan satu repositori yang seragam, teratur, relevan, terkawal dan terkini. SRP dibangunkan untuk memudahkan pengguna dan juga warga MAMPU mencapai maklumat berkaitan Pekeliling, Surat Pekeliling, Surat Arahan, Garis Panduan dan Arahan Teknologi Maklumat dengan lebih cepat dan tepat. 
                    </p>
                    ...
                    <p class="infoText" hidden>
                         Rasionalisasi pekeliling MAMPU ini dilaksanakan melalui lima peringkat rantaian nilai, iaitu peringkat semakan semula, penyediaan semula, percetakan, pengedaran serta promosi, repositori, pemantauan dan penambahbaikan. 
                    </p>
                    <p class="infoText" hidden >
                         Pekeliling yang telah dimuktamadkan dan mendapat kelulusan untuk edaran perlu didaftarkan oleh Bahagian Dasar Transformasi (BDT) mengikut pengelasan dan kategori tertentu dan turut dimuat naik ke dalam satu repositori maklumat dalam bentuk aplikasi bagi mempercepatkan capaian oleh para pelanggan MAMPU. Oleh itu, Repositori Pekeliling ini dibangunkan supaya dapat menyediakan penawaran perkhidmatan untuk para pelanggan dan juga warga MAMPU supaya dapat mencapai maklumat berhubung pekeliling, surat pekeliling, surat arahan dan perkara-perkaitan dengan lebih cepat dan tepat. 
                    </p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p class="infoText" style="text-align: center;">
                         <!-- Maklumat untuk Repositori Pekeliling ini akan dikemaskini dari semasa ke semasa.<br/> -->Sebarang pertanyaan boleh diajukan kepada<br/>
                         Bahagian Dasar Transformasi, MAMPU.
                    </p>
                </div>
            </div>
